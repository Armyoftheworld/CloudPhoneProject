...
public class ScreenEncoder implements Device.RotationListener {
    ...
    private final ByteBuffer headerBuffer = ByteBuffer.allocate(3 + 12);
...
//                                Ln.d(String.format("type = %s, profileLevel.profile = %d, profileLevel.level = %d",
//                                        type, profileLevel.profile, profileLevel.level));
//                            }
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
